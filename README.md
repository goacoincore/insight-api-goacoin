<h1 align="center">Insight-api-goacoin</h1>

<div align="center">
  <strong>A GoaCoin blockchain REST and WebSocket API Service</strong>
</div>
<br />
<div align="center">
  <!-- Stability -->
  ...
  <!-- Build Status -->
  <a href="https://travis-ci.org/goacoincore/insight-api-goacoin">
    <img src="https://img.shields.io/travis/goacoincore/insight-api-goacoin/master.svg?style=flat-square" alt="Build Status" />
  </a>
  <!-- NPM version -->
  <a href="https://npmjs.org/package/insight-api-goacoin">
    <img src="https://img.shields.io/npm/v/insight-api-goacoin.svg?style=flat-square" alt="NPM version" />
  </a>
</div>


This is a backend-only service. If you're looking for the web frontend application, take a look at https://github.com/goacoincore/insight-ui-goacoin.
...
- [Resources](#resources)
- [License](https://github.com/goacoincore/insight-api-goacoin/blob/master/LICENSE)

## Getting Started

```bashl
npm install -g bitcore-node-goacoin@latest
...
The API endpoints will be available by default at: `http://localhost:3001/insight-api-goacoin/`

### Prerequisites

- [Bitcore Node GoaCoin 3.x](https://github.com/goacoincore/bitcore-node-goacoin)

**Note:** You can use an existing GoaCoin data directory, however `txindex`, `addressindex`, `timestampindex` and `spentindex` needs to be set to true in `goacoin.conf`, as well as a few other additional fields.
...
### Block
```
  /insight-api-goacoin/block/[:hash]
  /insight-api-goacoin/block/0000000006e7b38e8ab2d351239019c01de9a148b5baef58cfe52dfd9917cedc
```

### Block Index
Get block hash by height
```
  /insight-api-goacoin/block-index/[:height]
  /insight-api-goacoin/block-index/0
```
This would return:
```
{
...
### Raw Block
```
  /insight-api-goacoin/rawblock/[:blockHash]
```
...
```
  /insight-api-goacoin/blocks?limit=3&blockDate=2017-04-22
```
...
### Transaction
```
  /insight-api-goacoin/tx/[:txid]
  /insight-api-goacoin/tx/ebdca263fe1c75c8609ce8fe3d82a320a0b3ca840f4df995883f5dab1b9ff8d9
  /insight-api-goacoin/rawtx/[:rawid]
  /insight-api-goacoin/rawtx/ebdca263fe1c75c8609ce8fe3d82a320a0b3ca840f4df995883f5dab1b9ff8d9
```

### Address
```
  /insight-api-goacoin/addr/[:addr][?noTxList=1][&from=&to=]
  /insight-api-goacoin/addr/ybi3gej7Ea1MysEYLR7UMs3rMuLJH5aVsW?noTxList=1
  /insight-api-goacoin/addr/yPv7h2i8v3dJjfSH4L3x91JSJszjdbsJJA?from=1000&to=2000
```

### Address Properties
```
  /insight-api-goacoin/addr/[:addr]/balance
  /insight-api-goacoin/addr/[:addr]/totalReceived
  /insight-api-goacoin/addr/[:addr]/totalSent
  /insight-api-goacoin/addr/[:addr]/unconfirmedBalance
```
The response contains the value in Satoshis.

### Unspent Outputs
```
  /insight-api-goacoin/addr/[:addr]/utxo
```
Sample return:
```
[
...
GET method:
```
  /insight-api-goacoin/addrs/[:addrs]/utxo
  /insight-api-goacoin/addrs/ygwNQgE5f15Ygopbs2KPRYMS4TcffqBpsz,ygw5yCtVkx3hREke4L8qDqQtnNoAiPKTSx/utxo
```

POST method:
```
  /insight-api-goacoin/addrs/utxo
```
...
```
  /insight-api-goacoin/txs/?block=HASH
  /insight-api-goacoin/txs/?block=000000000814dd7cf470bd835334ea6624ebf0291ea857a5ab37c65592726375
```
### Transactions by Address
```
  /insight-api-goacoin/txs/?address=ADDR
  /insight-api-goacoin/txs/?address=yWFfdp9nLUjy1kJczFhRuBMUjtTkTTiyMv
```

### Transactions for Multiple Addresses
GET method:
```
  /insight-api-goacoin/addrs/[:addrs]/txs[?from=&to=]
  /insight-api-goacoin/addrs/ygwNQgE5f15Ygopbs2KPRYMS4TcffqBpsz,ygw5yCtVkx3hREke4L8qDqQtnNoAiPKTSx/txs?from=0&to=20
```

POST method:
```
  /insight-api-goacoin/addrs/txs
```
...
GET method:
```
  /insight-api-goacoin/gobject/list/proposal
```
...
GET method:
```
  /insight-api-goacoin/gobject/get/[:hash]
  /insight-api-goacoin/gobject/get/b6af3e70c686f660541a77bc035df2e5e46841020699ce3ec8fad786f7d1aa35
```
...
### Masternodes List
```
  /insight-api-goacoin/masternodes/list
```
### Validate Masternode
```
  /insight-api-goacoin/masternodes/validate/[:payee]
  /insight-api-goacoin/masternodes/validate/yRuALkPpeYpTgxdNn2L5YgGktASJYDYPAo
```
...
```
  /insight-api-goacoin/sync
```

### Live Network P2P Data Sync Status
```
  /insight-api-goacoin/peer
```

### Status of the Bitcoin Network
```
  /insight-api-goacoin/status?q=xxx
```
...
### Utility Methods
```
  /insight-api-goacoin/utils/estimatefee[?nbBlocks=2]
```
...
- (Medium)[How to setup a GoaCoin Instant-Send Transaction using Insight API?????????The comprehensive way](https://medium.com/@obusco/setup-instant-send-transaction-the-comprehensive-way-a80a8a0572e)
